 ...
 * @version 1.0
 */
public class StochasticNeuralNetworkOptimizationProblem implements HillClimbingProblem, GeneticAlgorithmProblem {
     ...
     */
    public StochasticNeuralNetworkOptimizationProblem(DataSet examples,
             NeuralNetwork network, ErrorMeasure measure, int batchSize) {
        eval = new StochasticNeuralNetworkEvaluationFunction(network, examples, measure, batchSize);
